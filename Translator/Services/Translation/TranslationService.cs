...
public class TranslationService : ITranslationService
{
    ...
    ///     The method first replaces phrases, then translates individual words, and finally capitalizes the first letter of
    ///     the result.
    /// </summary>
    ...
    public string Translate(string input)
    {
        ...
        var translatedWords = words.Select(word =>
        {
            ...
            if (_dictionary.TryGetValue(wordWithoutPunctuation.ToLower(), out var translation))
                return translation + punctuation;
            return wordWithoutPunctuation + punctuation;
        });
