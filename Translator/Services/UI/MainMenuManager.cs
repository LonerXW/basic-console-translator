...
namespace Translator.Services.UI
{
    ...
    public class MainMenuManager
    {
        ...
        public MainMenuManager(IConsoleUIService uiService, IDictionaryLoader dictionaryLoader, string basePath, LanguageConfig config)
        {
        ...
        private void HandleTranslationMode()
        {
            ...
            while (stayInLanguageSelection)
            {
                try
                {
                    ...
                    bool continueApp = _uiService.RunTranslationLoop(translator);
