...
namespace Translator.Tests
{
    public class TranslationIntegrationTests
    {
        ...
        [Fact]
        public void Translate_SimpleWord() => Assert.Equal("Привіт", _service.Translate("hello"));

        [Fact]
        public void Translate_Phrase() => Assert.Equal("Добрий ранок", _service.Translate("good morning"));

        [Fact]
        public void Translate_UnknownWord() => Assert.Equal("Unknownword", _service.Translate("unknownword"));

        [Fact]
        public void Translate_TextWithPunctuation() => Assert.Equal("Привіт, світ!", _service.Translate("hello, world!"));

        [Fact]
        public void Translate_TextWithCapitalization() => Assert.Equal("Привіт світ", _service.Translate("Hello world"));
    }
} 